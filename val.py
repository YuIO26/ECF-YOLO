...
if __name__ == '__main__':
    model_path = '/home/noah/fengyu/yolov12-main/runs/train-yolov8n-VisDrone/weights/best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data='/home/noah/fengyu/ultralytics-yolo11-main/ultralytics/cfg/datasets/VisDrone.yaml',
